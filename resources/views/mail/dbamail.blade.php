                    ...
                    <td style='text-align:center'>
                        <div
                            ...
                            <div style="padding-bottom: 30px; font-size: 17px;">
                                <strong>Thanks for registering for DBAWorkshop!</strong>
                            </div>
                            <div style="padding-bottom: 30px">
                                Hi {{ ucfirst($name) }},<br><br>
                                You received this email because your payment for the ConnectinSkillz DBAWorkshop as been confirmed.<br>
                                We also want to invite you to our referral program, where you get to earn with us by making others sign up for this program.
                                <br><br>
                            ...
                            <div style="padding-bottom: 40px; text-align:center;">
                                <a href="#" rel="noopener"
                                    ...
                                    target="_blank">Join Our Referral Program</a>
                            </div>
