                    ...
                    <td style='text-align:center'>
                        <div
                            ...
                            <div style="padding-bottom: 30px">
                                ...
                                You received this email because you tried to register with ConnectinSkillz. Click on the
                                link below to create a password to enable login to the platform.
                                <br><br>
                            ...
                            <div style="padding-bottom: 40px; text-align:center;">
                                <a href="https://www.connectinskillz.com/waitlist/verify/{{ $ref }}" rel="noopener"
                                    ...
                                    target="_blank">Create Password</a>
                            </div>
